...
Terdapat **2 orang (kelas)** yaitu `amba` dan `bahlil`, masing-masing dengan **3 foto wajah** sebagai data training. Total = **6 gambar**.
...
```
Matrix Data =
┌─ gambar 1 (amba_1)   → [p1, p2, p3, ..., p10000] ─┐
│  gambar 2 (amba_2)   → [p1, p2, p3, ..., p10000]   │
│  gambar 3 (amba_3)   → [p1, p2, p3, ..., p10000]   │
│  gambar 4 (bahlil_1) → [p1, p2, p3, ..., p10000]   │
│  gambar 5 (bahlil_2) → [p1, p2, p3, ..., p10000]   │
└─ gambar 6 (bahlil_3) → [p1, p2, p3, ..., p10000] ─┘
```
...
```
Upload gambar wajah test: Ambatukam (1).jpg
```
...
test_img = cv2.imread('Ambatukam (1).jpg', cv2.IMREAD_GRAYSCALE)
